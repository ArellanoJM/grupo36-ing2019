...
<?php 
echo "¿Confirma la eliminación de la propiedad?";
?>
...
echo "<form method='POST' action='eliminar_propiedad_chk.php' enctype='multipart/form-data' name='eliminar_propiedad_form'>

                 <input type='hidden' id='id_propiedad_form' name='name_id_propiedad_form' value='$id_propiedad_form'/>
               
                 
             <input class='button' type='submit'  value='Confirmar Eliminación' />
